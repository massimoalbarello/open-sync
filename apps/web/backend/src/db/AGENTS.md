...
- Give each migration one schema concern. Keep it deterministic and transactional where the engine
  ...
  tables.
- Once a migration has been applied to a non-disposable environment, its identity and contents are
  immutable. Use the [compatibility policy](../../../../../COMPATIBILITY.md) to establish that boundary.
